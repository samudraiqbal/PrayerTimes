...
import id.sch.smktelkom_mlg.project2.xirpl511203031.prayertimes.widget.PrayerTimeWidget;
import id.sch.smktelkom_mlg.project2.xirpl511203031.prayertimes.widget.SmallPrayerTimeWidget;
        ...
        try {
            ...
            listPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object o) {
                    ...
                    listPref.setSummary("en".equals(newVal) ? getString(R.string.english) : getString(R.string.indonesia));
            ...
            listPref.setSummary("en".equals(lang) ? getString(R.string.english) : getString(R.string.indonesia));
